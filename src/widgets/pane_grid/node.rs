        ...
        match (self, count) {
            (
                ...
                let (region_a, region_b, _ratio) = axis.split(
                    ...
                    *ratio,
                    spacing,
                    min_size * Self::usize_to_f32(a_factor + 1)
                        + spacing * Self::usize_to_f32(a_factor),
                    min_size * Self::usize_to_f32(b_factor + 1)
                        + spacing * Self::usize_to_f32(b_factor),
                );
